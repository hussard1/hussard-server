...
<html>
	<head>
		...
		<title><spring:message code="ttl.bbs.admin.form.title"/></title>
	</head>
	<body>
		<main>
			<div class="content_style">
				<div class="h3_wrap">
					<h3><spring:message code="ttl.bbs.admin.form.title"/></h3>
				</div>
				<form:form method="post" action="savebbs.sag" commandName="config">
